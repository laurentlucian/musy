...
export class Playlist extends ReadWriteBaseClient {
  ...
  changePlaylistDetails(
    playlistId: string,
    optionalParams?: ChangePlaylistDetailsOptionalParams,
  ) {
  ...
  getPlaylistItems(
    playlistId: string,
    optionalParams?: GetPlaylistItemsOptionalParams,
  ) {
  ...
  updatePlaylistItems(
    playlistId: string,
    optionalParams?: UpdatePlaylistItemsOptionalParams,
  ) {
    return this.put<UpdatePlaylistItemsResponse>(
      `/playlists/${playlistId}/tracks`,
      optionalParams,
    );
  }
  ...
  addItemsToPlaylist(
    playlistId: string,
    optionalParams: AddItemsToPlaylistOptionalParams,
  ) {
    return this.post<AddItemsToPlaylistResponse>(
      `/playlists/${playlistId}/tracks`,
      optionalParams,
    );
  }
  ...
  removePlaylistItems(
    playlistId: string,
    bodyParams: RemovePlaylistItemsParams,
  ) {
    return this.delete<RemovePlaylistItemsResponse>(
      `/playlists/${playlistId}/tracks`,
      bodyParams,
    );
  }
  ...
  getCurrentUserPlaylists(
    optionalParams?: GetUserSavedPlaylistsOptionalParams,
  ) {
  ...
  createPlaylist(
    userId: string,
    playlistName: string,
    optionalParams: CreatePlaylistOptionalParams,
  ) {
    return this.post<PlaylistDetail>(`/users/${userId}/playlists`, {
      name: playlistName,
      ...optionalParams,
    });
  }
  ...
  getFeaturedPlaylist(optionalParams?: GetFeaturedPlaylistOptionalParams) {
    return this.get<FeaturedPlaylist>(
  ...
  getCategoryPlaylist(
    categoryId: string,
    optionalParams?: GetCategoryPlaylistOptionalParams,
  ) {
    return this.get<CategoryPlaylist>(
