...
const Profile = () => {
  const { user, playback, recent, currentUser, party, liked, top } =
...
export const loader: LoaderFunction = async ({ request, params }) => {
  ...
  try {
    ...
    return { user, playback, recent, party, currentUser, liked, top };
  } catch {
    // will catch error if existingUser doesn't have required scopes in spotify authorization
    // user needs to reauthenticate
    return { user, playback, recent, party, currentUser, liked, top: null };
  }
};
