    ...
    <div className="ml-5 h-full w-full space-y-6">
      <div className="flex items-center justify-between">
        ...
        >
          <Ghost
            size="24"
            color={currentUser.settings?.isPrivate ? spotifyGreen : "#555555"}
          />
          private profile
        </label>
        <Switch
      ...
      <div className="flex items-center justify-between">
        ...
        >
          <Scroll
            size="24"
            color={currentUser.settings?.autoscroll ? spotifyGreen : "#555555"}
          />
          auto scroll
        </label>
        <Switch
      ...
      <div className="flex items-center justify-between">
        ...
        >
          <MusicPlay
            size="24"
            color={
              currentUser.settings?.allowPreview ? spotifyGreen : "#555555"
            }
            variant="Bold"
          />
          song preview
      ...
      <div className="flex items-center justify-between">
        ...
        >
          <Code1
            size="24"
            color={currentUser.settings?.dev ? spotifyGreen : "#555555"}
          />
          dev mode
        </label>
        <Switch
