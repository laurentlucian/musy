...
export class Player extends ReadWriteBaseClient {
  ...
  transferPlayback(
    deviceIds: string[],
    optionalParams: TransferPlaybackOptionalParams,
  ) {
  ...
  getCurrentlyPlayingTrack(optionalParams?: CurrentlyPlayingTrackParams) {
    return this.get<CurrentlyPlayingTrack>(
  ...
  startResumePlayback(deviceId: string, params: ResumePlaybackParams) {
    return this.put(
      `/me/player/play${generateQueryParametersString({ device_id: deviceId })}`,
      params,
    );
  }
  ...
  pausePlayback(deviceId?: string) {
    return this.put(
      `/me/player/pause${generateQueryParametersString({ device_id: deviceId })}`,
    );
  }
  ...
  skipToNext(deviceId?: string) {
    return this.post(
      `/me/player/next${generateQueryParametersString({ device_id: deviceId })}`,
    );
  }
  ...
  skipToPrevious(deviceId?: string) {
    return this.post(
      `/me/player/previous${generateQueryParametersString({ device_id: deviceId })}`,
    );
  }
  ...
  seekToPosition(
    positionMS: number,
    optionalParams?: SeekToPositionOptionalParam,
  ) {
    return this.put(
      `/me/player/seek${generateQueryParametersString({ position_ms: positionMS, ...optionalParams })}`,
    );
  }
  ...
  setRepeatMode(
    state: RepeatState,
    optionalParams?: SetRepeatModeOptionalParams,
  ) {
    return this.put(
      `/me/player/repeat${generateQueryParametersString({ state, ...optionalParams })}`,
    );
  }
  ...
  setPlaybackVolume(
    volume: number,
    optionalParams?: SetPlaybackVolumeOptionalParams,
  ) {
    return this.put(
      `/me/player/volume${generateQueryParametersString({ volume_percent: volume, ...optionalParams })}`,
    );
  }
  ...
  togglePlaybackShuffle(
    state: boolean,
    optionalParams: TogglePlaybackShuffleOptionalParams,
  ) {
    return this.put(
      `/me/player/shuffle${generateQueryParametersString({ state, ...optionalParams })}`,
    );
  }
  ...
  getRecentlyPlayedTracks(
    optionalParams: GetRecentlyPlayedTracksOptionalParams,
  ) {
    return this.get<RecentlyPlayedTracks>(
  ...
  addItemToPlaybackQueue(
    uri: string,
    optionalParams?: AddItemToPlaybackQueueOptionalParams,
  ) {
    return this.post(
