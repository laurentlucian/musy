...
INSERT INTO "new_Settings" ("allowQueue", "autoscroll", "createdAt", "id", "isPrivate", "updatedAt", "userId") SELECT "allowQueue", "autoscroll", "createdAt", "id", "isPrivate", "updatedAt", "userId" FROM "Settings";
DROP TABLE "Settings";
