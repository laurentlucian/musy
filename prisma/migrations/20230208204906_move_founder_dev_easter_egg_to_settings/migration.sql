/*
  ...
  - You are about to drop the column `dev` on the `Profile` table. All the data in the column will be lost.
  - You are about to drop the column `easterEgg` on the `Profile` table. All the data in the column will be lost.
  - You are about to drop the column `founder` on the `Profile` table. All the data in the column will be lost.
