/*
  ...
  - Added the required column `userImage` to the `Party` table without a default value. This is not possible if the table is not empty.
  - Added the required column `userName` to the `Party` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Party" ("assignedAt", "ownerId", "userId") SELECT "assignedAt", "ownerId", "userId" FROM "Party";
DROP TABLE "Party";
