...
INSERT INTO "new_RecommendedSongs" ("action", "albumName", "albumUri", "artist", "artistUri", "comment", "createdAt", "explicit", "id", "image", "name", "ownerId", "pending", "senderId", "trackId", "uri") SELECT "action", "albumName", "albumUri", "artist", "artistUri", "comment", "createdAt", "explicit", "id", "image", "name", "ownerId", "pending", "senderId", "trackId", "uri" FROM "RecommendedSongs";
...
INSERT INTO "new_LikedSongs" ("action", "albumName", "albumUri", "artist", "artistUri", "explicit", "id", "image", "likedAt", "name", "trackId", "uri", "userId") SELECT "action", "albumName", "albumUri", "artist", "artistUri", "explicit", "id", "image", "likedAt", "name", "trackId", "uri", "userId" FROM "LikedSongs";
...
INSERT INTO "new_RecentSongs" ("action", "albumName", "albumUri", "artist", "artistUri", "duration", "explicit", "id", "image", "name", "playedAt", "trackId", "uri", "userId") SELECT "action", "albumName", "albumUri", "artist", "artistUri", "duration", "explicit", "id", "image", "name", "playedAt", "trackId", "uri", "userId" FROM "RecentSongs";
...
INSERT INTO "new_Queue" ("action", "albumName", "albumUri", "artist", "artistUri", "createdAt", "explicit", "id", "image", "name", "ownerId", "pending", "trackId", "uri", "userId") SELECT "action", "albumName", "albumUri", "artist", "artistUri", "createdAt", "explicit", "id", "image", "name", "ownerId", "pending", "trackId", "uri", "userId" FROM "Queue";
DROP TABLE "Queue";
