/*
  ...
  - You are about to drop the column `gradientColorDark` on the `Theme` table. All the data in the column will be lost.
  - You are about to drop the column `gradientColorLight` on the `Theme` table. All the data in the column will be lost.
