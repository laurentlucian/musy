/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c ./wrangler.jsonc --env-interface Env` (hash: 98c0bd5697848197878c7075cda81259)
// Runtime types generated with workerd@1.20251210.0 2025-06-17 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		D1: D1Database;
		WORKFLOW_QUEUE: Workflow<Parameters<import("./workers/app").WorkflowQueue['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SESSION_SECRET" | "SPOTIFY_CLIENT_ID" | "SPOTIFY_CLIENT_SECRET" | "SPOTIFY_CALLBACK_URL" | "DISCORD_BOT_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN">> {}
}
